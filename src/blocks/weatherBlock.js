    ...
    return (
        <div style={{ width: "100%", height: "100%" }}>
            ...
            <Loader loaded={weatherData.status === "success"}>
                ...
                >
                    <div style={{ width: "60%", height: "100%" }} ref={temperatureText} weather="yeah">
...
function WeatherIconDefinitions() {
    // Definitions from Weather.com
    return (
        <>
            <svg style={{ position: "absolute", width: "0", height: "0" }} viewBox="0 0 200 200">
                ...
                <defs>
                    ...
                    <mask
                        id="isolated-thunderstorms-mask"
                        fill="var(--color-thunderstorm-mask)"
                    >
                        <g>
                            <rect width="100%" height="100%" fill="#FFF"></rect>
                            ...
                            <use
                                href="#svg-symbol-cloud"
                                transform="matrix(.6 0 0 .6 88 26.5)"
                                stroke="var(--color-thunderstorm-mask)"
                                strokeWidth="10"
                            ></use>
                        </g>
                    </mask>
                    <mask id="mostly-clear-night-mask">
                        ...
                        <use
                            href="#svg-symbol-cloud"
                            transform="translate(56 19) scale(.27317)"
                            strokeWidth="15"
                            stroke="#000"
                        ></use>
                    </mask>
                    <mask id="mostly-cloudy-night-mask">
                        ...
                        <use
                            href="#svg-symbol-cloud"
                            transform="translate(32.526 -14.885) scale(.55128)"
                            strokeWidth="10"
                            stroke="#000"
                        ></use>
                    </mask>
                    <mask id="mostly-sunny-mask">
                        ...
                        <use
                            href="#svg-symbol-cloud"
                            transform="translate(92 10) scale(.7125)"
                            strokeWidth="12"
                            stroke="#000"
                        ></use>
                    </mask>
                    <mask id="partly-cloudy-night-mask">
                        ...
                        <use
                            href="#svg-symbol-cloud"
                            transform="matrix(.6 0 0 .6 49 -26)"
                            strokeWidth="3"
                            stroke="#000"
                        ></use>
                    </mask>
                    <mask id="partly-cloudy-mask">
                        ...
                        <use
                            href="#svg-symbol-cloud"
                            transform="translate(3.571 -44.642) scale(1.7857)"
                            stroke="#000"
                            strokeWidth="13"
                        ></use>
                    </mask>
                    <mask id="scattered-showers-night-mask">
                        <rect width="100%" height="100%" fill="#FFF"></rect>
                        <use
                            href="#svg-symbol-moon"
                            transform="matrix(.91 0 0 .91 6 46)"
                            strokeWidth="10"
                            stroke="#000"
                    ...
                    <mask id="scattered-snow-night-mask">
                        ...
                        <use
                            href="#svg-symbol-moon"
                            transform="matrix(.99 0 0 .99 3 39)"
                            strokeWidth="14"
                            stroke="#000"
                            strokeLinejoin="round"
                        ></use>
                    ...
                    <mask id="scattered-snow-mask">
                        ...
                        <use
                            href="#svg-symbol-cloud"
                            transform="translate(-5.355 -24.99) scale(1.785)"
                            stroke="#000"
                            strokeWidth="13"
                        ></use>
                    </mask>
                    ...
                    <mask id="scattered-thunderstorms-mask">
                        ...
                        <use
                            href="#svg-symbol-cloud"
                            transform="matrix(1.8 0 0 1.8 -10.8 -25.2)"
                            stroke="#000"
                            strokeWidth="13"
                        ></use>
                    </mask>
            ...
            <div style={{ display: "none" }}>
                <svg>
                    ...
                    <symbol id="svg-symbol-sun" fill="var(--color-sun)">
                        <use href="#svg-symbol-sun-ray"></use>
                        <use
                            href="#svg-symbol-sun-ray"
                    ...
                    >
                        <use
                            href="#svg-symbol-snowflake-branch"
